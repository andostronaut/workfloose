...
module.exports = () => {
  const questions = [
    ...
    },
    {
      ...
      when: (answers) => {
        return (
          !Array.isArray(answers.workflows) ||
          answers.workflows.includes(constants.CI_WORKFLOW) ||
          answers.workflows.includes(constants.CD_WORKFLOW)
        )
      },
      filter: (val) => {
        return val.toLowerCase()
    ...
    },
    {
      ...
      message: 'Would you like to generate Procfile?',
      default: true,
      when: (answers) => {
        return answers.deployer === constants.HEROKU_DEPLOYER
      }
    },
    {
      type: 'checkbox',
    ...
    },
    {
      ...
      when: (answers) => {
        return (
          answers.dependabot &&
          answers.environemt === constants.NODE_ENVIRONMENT &&
          answers.workflows.includes(constants.CI_WORKFLOW)
        )
      },
      filter: (val) => {
    ...
    },
    {
      ...
      when: (answers) => {
        return (
          answers.dependabot &&
          answers.environemt === constants.PHP_ENVIRONMENT &&
          answers.workflows.includes(constants.CI_WORKFLOW)
        )
      },
      filter: (val) => {
    ...
    },
    {
      ...
      when: (answers) => {
        return (
          answers.dependabot &&
          answers.environemt === constants.GO_ENVIRONMENT &&
          answers.workflows.includes(constants.CI_WORKFLOW)
        )
      },
      filter: (val) => {
    ...
    },
    {
      ...
      when: (answers) => {
        return (
          answers.dependabot &&
          answers.environemt === constants.RUBY_ENVIRONMENT &&
          answers.workflows.includes(constants.CI_WORKFLOW)
        )
      },
      filter: (val) => {
    ...
    },
    {
      ...
      when: (answers) => {
        return (
          answers.dependabot &&
          answers.environemt === constants.PYTHON_ENVIRONMENT &&
          answers.workflows.includes(constants.CI_WORKFLOW)
        )
      },
      filter: (val) => {
